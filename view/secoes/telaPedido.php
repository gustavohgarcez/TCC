                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row distance">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="CPF" name="txtCPF" placeholder="Digite apenas números" class="form-control input-md"
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="Nome" name="txtNome" placeholder="Digite o nome do cliente" class="form-control input-md"
                                required="" type="text">
                        </div>
                    </div>
